...
{
    char *cpy = malloc(strlen(query_string)+1);
    memset(cpy, 0, strlen(query_string) + 1);
    strcpy(cpy, query_string);
    ...
    // keyval_llist *uri_query = malloc(sizeof(keyval_llist));
    //
    // char *index = query_string;
